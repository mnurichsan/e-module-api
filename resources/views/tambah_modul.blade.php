        ...
        <div class="row justify-content-center mt-3">
            <div class="col-md-12">
                <form method="POST" action="{{ route('module.store') }}">
                    @csrf
                    <div class="card">
                        <div class="card-header">{{ __('Create Modul') }}</div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="module_title" class="form-control" id="module-title" required
                                    placeholder="Masukkan Module Title">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="module_author" class="form-control" id="module-author" required
                                    placeholder="Masukkan Module Author">
                            </div>
                            <div class="mb-3">
                                <label for="des-module" class="form-label">Deskripsi Module</label>
                                <textarea class="form-control" name="des_module" id="des-module" rows="3" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="content-module" class="form-label">Content Module</label>
                                <textarea class="form-control" name="content_module" id="content-module" required></textarea>
                            </div>
